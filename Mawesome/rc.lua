...
browser = "exo-open --launch WebBrowser" or "vivaldi-snapshot"
...
myawesomemenu = {
    ...
    { "manual", terminal .. "man awesome", menubar.utils.lookup_icon("system-help") },
    { "edit config", gui_editor .. "atom" .. awesome.conffile,  menubar.utils.lookup_icon("accessories-text-editor") },
